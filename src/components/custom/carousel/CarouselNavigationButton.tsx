...
const CarouselNavigationButton: FC<CarouselNavigationButtonProps> = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "transition-all duration-300 lg:duration-200 hover:lg:scale-110 active:scale-75 active:lg:scale-90 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 h-min",
        className
      )}
